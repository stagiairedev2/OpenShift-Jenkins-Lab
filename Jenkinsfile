...
def replicas = "1"
def devProject = "stagieredev2-dev" // TODO: Your dev project name goes here
def testProject = "stagieredev2-dev" // TODO: Your test project name goes here
def prodProject = "stagieredev2-dev" // TODO: Your prod project name goes here
